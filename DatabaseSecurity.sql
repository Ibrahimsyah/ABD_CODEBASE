...
SELECT ON TABLE JADWAL TO ROLE DOSEN,
                               ...
                               KAPRODI;
GRANT
SELECT ON TABLE MATKUL TO ROLE KAPRODI;
...
--Permission for MATKUL
CREATE PERMISSION P4 ON MATKUL
FOR ROWS
WHERE VERIFY_ROLE_FOR_USER(SESSION_USER, 'KAPRODI') = 1
ENFORCED FOR ALL ACCESS ENABLE;
ALTER TABLE MATKUL ACTIVATE ROW ACCESS CONTROL;
